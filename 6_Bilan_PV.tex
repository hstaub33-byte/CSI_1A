    ...
    \column{0.48\textwidth}
      \begin{pcbanner}{Avancées}
        \begin{itemize}\footnotesize
          ...
          \item Génération Bouguer
          \item Recombinaisons SRH, Auger, radiatif
          \item Recherche sur l'hétérojonction CIGS/ZnO/CdS
    ...
    \column{0.48\textwidth}
      \begin{pcbanner}{Jalons clés}
        \begin{itemize}\footnotesize
          ...
          \item Comparaison réussie pour l'homojonction et CL ohmique avec et sans génération
        \end{itemize}
      \end{pcbanner}
  \end{columns}
...
\end{frame}
 ...
 \begin{frame}[t]{Brique photovoltaïque : validation}
   ...
   \begin{pccard}
     ...
     \begin{tikzpicture}
      \begin{axis}[
        ...
        xlabel={$x$ ($\mu$m)},
        ylabel={Densités de porteurs ($\mathrm{cm^{-3}}$)},
        ymode=log,
   ...
   \end{pccard}
    ...
    {\tiny\color{pcNavy!60} Sources : SCAPS-1D, Burgelman \textit{et al.} (2000)}
 \end{frame}
