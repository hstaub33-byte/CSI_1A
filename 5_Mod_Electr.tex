  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.48\textwidth}
      ...
      \begin{pcbanner}{Différents angles d'approche}
        ...
        \begin{pcbannerlight}{Apport du \ch{CO2}}
          \vspace{0.3em}
          \begin{itemize}\footnotesize
                \item Bullage dans l'électrolyte 
                \item Électrode à diffusion de gaz (GDE)
          \end{itemize}
        \end{pcbannerlight}
...
\begin{frame}[t]{Modèles : partie électrochimique}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \end{columns}
  {\tiny\color{pcNavy!60} Sources : Newman \& Balsara, \textit{Electrochemical Systems} ; Le \textit{et al.} (2017)}

\end{frame}

%--------------------------------------------------------------------
\begin{frame}[t]{Électrochimie : cas simplifié \ch{CO2} $\rightarrow$ \ch{CO}}
  \vspace{-1em}
...
\vspace{-0.5em}
   ...
   \begin{pcbanner}{Module de Thiele $\phi$}
    ...
    \end{columns}
      {\tiny\color{pcNavy!60} Sources : Wan \textit{et al.} ; Whitaker (1999)}
\end{frame}