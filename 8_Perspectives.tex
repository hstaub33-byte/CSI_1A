...
\begin{frame}[t]{Perspectives : compléter et construire}
  ...
  \begin{columns}[T,onlytextwidth]
    \column{0.48\textwidth}
      ...
      \end{pcbanner}
    \column{0.48\textwidth}
      \begin{pcbanner}{Brique Électrochimique}
        \begin{itemize}\footnotesize
  ...
  \begin{columns}[T,onlytextwidth]
    \column{\textwidth}
      \begin{pcbanner}{Construire/Comprendre de nouvelles briques}
        \begin{itemize}\footnotesize
          \item Photogénération : passer à l'électromagnétique
          \item \textit{Detailed balance} : approche alternative 
        \end{itemize}
      \end{pcbanner}
  \end{columns}

  {\tiny\color{pcNavy!60} Sources : Vossier \textit{et al.} (2015) ; Kessinger \textit{et al.} (2022)}
\end{frame}
