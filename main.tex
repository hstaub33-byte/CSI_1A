...
\begin{frame}[t]{Modèles : partie électrochimique}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \column{0.48\textwidth}
      \vspace{-0.5em}
      \begin{pcbanner}{Modèle électrochimique}
        \vspace{0.3em}
        \centering\scriptsize
        ...
        \[ j = j_0\!\left[\exp\!\Big(\!-\frac{\alpha_c F\eta}{RT}\Big) - \exp\!\Big(\frac{\alpha_a F\eta}{RT}\Big)\right] \]
      \end{pcbanner}
   ...
   \begin{pccard}
     ...
     \begin{tikzpicture}
      \begin{axis}[
        ...
        % % --- Trous p ---
        \addplot[red!70!black, thick] table[x=x, y=p_code, col sep=semicolon] {donnees1.csv};
        \addlegendentry{$p$ (code)}
        \addplot[red!70!black, only marks, mark=square, mark size=1.1pt, each nth point=4]
     ...
     {\scriptsize\bfseries\color{pcNavy}
      Densités de porteurs : comparaison code / SCAPS-1D}
   \end{pccard}
 \end{frame}
